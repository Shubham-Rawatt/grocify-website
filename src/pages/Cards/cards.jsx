...
const Cards = ({img ,title, rate}) => {
  return (
    <div className='bg-zinc-100 p-5 rounded-xl'>
        ...
        <div className='w-full h-50'> <img src={img} alt="image list" className='w-full h-full object-contain'/></div>

    <div className='text-center'>
        <h3 className='text-2xl font-semibold'>{title}</h3>
        <p className='text-2xl font-bold mt-4 mb-3'>${rate.toFixed(2)}</p>
